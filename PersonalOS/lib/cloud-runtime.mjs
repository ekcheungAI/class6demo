...
export async function cloudRuntime(auth,{fetcher=fetch,config=connectionConfig()}={}){
 ...
 return {workspace,client,job,brand,request,rpc,
  ...
  update:(value,state,patch={})=>rpc('personalos_update',{p_workspace:workspace,p_id:value.id,p_version:value.version,p_state:state,p_patch:patch}),
