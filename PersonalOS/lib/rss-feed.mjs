...
export async function collectRss(sourceId,workspace,sources=rssConfig.sources){
 const source=sources.find(s=>s.id===sourceId);if(!source)throw new ContentError('請選擇已核對RSS預設');
